...
class RdAgentFhirPseudonymizerControllerIT extends BaseIT {
  ...
  void resolvePseudonyms_shouldReturnSecurePseudonym() {
    ...
    transportIdService.storeMapping(tId, sId).block();
  ...
  void resolvePseudonyms_multipleMappings_shouldResolveAll() {
    ...
    transportIdService.storeMapping("tId-1", "sId-1").block();
    transportIdService.storeMapping("tId-2", "sId-2").block();
    transportIdService.storeMapping("tId-3", "sId-3").block();
