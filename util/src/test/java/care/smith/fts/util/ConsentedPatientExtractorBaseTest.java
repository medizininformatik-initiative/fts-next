...
class ConsentedPatientExtractorBaseTest {
  ...
  void processConsentedPatients() {
    ...
    var result =
        ConsentedPatientExtractorBase.processConsentedPatients(
  ...
  void processConsentedPatient_withAllPolicies() {
    ...
    var result =
        ConsentedPatientExtractorBase.processConsentedPatient(
            PATIENT_IDENTIFIER_SYSTEM,
            POLICY_SYSTEM,
            bundle,
            POLICIES_TO_CHECK,
  ...
  void hasAllPolicies_withAllRequired() {
    ...
    var result =
        ConsentedPatientExtractorBase.hasAllPolicies(POLICY_SYSTEM, bundle, POLICIES_TO_CHECK);
  ...
  void getConsentedPolicies() {
    ...
    var result =
        ConsentedPatientExtractorBase.getConsentedPolicies(
  ...
  void getPermitProvisionsStream() {
    ...
    var provisions =
        ConsentedPatientExtractorBase.getPermitProvisionsStream(bundle)
            .collect(Collectors.toList());
  ...
  void getConsentedPoliciesFromProvision() {
    ...
    var result =
        ConsentedPatientExtractorBase.getConsentedPoliciesFromProvision(
  ...
  void extractPolicyFromCodeableConcept() {
    ...
    var policies =
        ConsentedPatientExtractorBase.extractPolicyFromCodeableConcept(
