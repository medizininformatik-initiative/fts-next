...
public class TransferProcessController {
  ...
  Mono<ResponseEntity<Object>> start(
    ...
    if (process.isPresent()) {
      ...
      var id =
          processRunner.start(
              process.get(), Optional.ofNullable(identifiers).orElse(List.of()));
...
"""
{
  "cohortSelector":{"trustCenterAgent":{"server":{"baseUrl":"http://tc-agent:8080"},"domain":"MII","patientIdentifierSystem":"http://fts.smith.care","policySystem":"https://ths-greifswald.de/fhir/CodeSystem/gics/Policy","policies":["IDAT_erheben","IDAT_speichern_verarbeiten","MDAT_erheben","MDAT_speichern_verarbeiten"],"signerIdType":"Pseudonym"}},
  "dataSelector":{"everything":{"fhirServer":{"baseUrl":"http://cd-hds:8080/fhir"}},
  "deidentificator":{"deidentifhir":{"trustCenterAgent":{"server":{"baseUrl":"http://tc-agent:8080"},"domains":{"pseudonym":"MII","salt":"MII","dateShift":"MII"}},"maxDateShift":"P14D","deidentifhirConfig":"/app/projects/example/deidentifhir/CDtoTransport.profile"}},
