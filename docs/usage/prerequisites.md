...
The Trust Center Agent is configured to work
with [gICS](https://www.ths-greifswald.de/forscher/gics)
for consent management and [gPAS](https://www.ths-greifswald.de/forscher/gpas/) for pseudonym
management and a redis compatible key-value store e.g. [Valkey](https://valkey.io/).
